...
def create_budget(active_user_id):
    ...
    sum_total = [new_budget_id, active_user_id, budget_name, sum_shopping, sum_food, sum_entertainment, sum_other]
