...
def create_budget(active_user):
    ...
    #  As long as chosen budget name is empty or only contains spaces ask for new budget name. 
    try_again = True
    while try_again == True: 
        ...
        if len(budget_name) != 0 and budget_name.isspace() is False:
            ...
            colors.print_text_color_red("Your budget name can't be empty or only contain spaces!")
